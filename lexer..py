...
class Lexer:
    ...
    def get_next_token(self):
        ...
        while self.current_char is not None:
            ...
            # Ігноруємо невідомі символи та переходимо до наступного токена
            self.advance()
...
class Parser:
    ...
    def term(self):
        """Парсер для 'term' правил граматики. У нашому випадку - це цілі числа або вирази в дужках."""
    ...
    def factor(self):
        """Парсер для 'factor' правил граматики. Фактор - це 'term', який може бути помножений або поділений."""
        node = self.term()
...
class Interpreter:
    ...
    def visit_BinOp(self, node):
        if node.op.type == TokenType.PLUS:
            ...
            raise ValueError(f"Невідомий оператор: {node.op.type}")
    ...
    def interpret(self, tree):
        if isinstance(tree, BinOp):
            ...
            return self.visit_Num(tree)
        else:
            raise ValueError(f"Невідомий тип вузла AST: {type(tree)}")
    ...
    def visit(self, node):
        ...
        if visitor:
            ...
            raise ValueError(f"Невідомий тип вузла AST: {type(node).__name__}")
...
def main():
    ...
    while True:
        try:
            ...
            print(f"Лексична помилка: {e}")
        except ParsingError as e:
            print(f"Помилка синтаксичного аналізу: {e}")
